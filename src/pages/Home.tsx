...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="relative flex flex-col items-center justify-start px-4 sm:px-6 lg:px-8 min-h-[150vh]">
        {/* Main */}
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 px-4">
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.95 }}>
                  ...
                  >
                    <div className="absolute inset-0 bg-gradient-to-r from-blue-600/50 to-blue-700/50 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
