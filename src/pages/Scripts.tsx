...
/////
// Code is So fucking SO fucking bad & messy, but it works man 😭
////
              ...
              <div className="max-w-2xl mx-auto mb-8 flex space-x-4 items-center">
                <div className="relative w-full">
                  <input
                    ...
                    className="w-full px-4 py-3 bg-blue-500/5 border border-blue-500/20 rounded-lg text-white placeholder-blue-400/60 focus:outline-none"
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {SResults.map((script, index) => (
                  ...
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    className="bg-gradient-to-br from-black to-blue-950/30 backdrop-blur-xl border border-blue-500/20 rounded-lg overflow-hidden"
                  >
                    <div className="p-6">
                      {/* Script details */}
