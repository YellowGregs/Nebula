...
export default function DownloadPage() {
  ...
  const handleDownload = () => {
    if (jsonData) {
      ...
      if (downloadLink) {
        ...
        console.warn(`No download link for version ${selectedVersion}`);
      }
    }
  };
  ...
  const isAvailable = jsonData?.ApkLink[selectedVersion];
              ...
              <div className="p-8 flex flex-col h-full">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 mt-auto">
                  <motion.button
                    ...
                    className={`w-full sm:w-auto inline-flex items-center justify-center px-6 py-3 rounded-xl font-medium transition-all duration-300 group
                      ${
                        isAvailable
                          ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-white hover:shadow-lg hover:shadow-blue-500/20'
                          : 'bg-blue-500/10 text-blue-400 border border-blue-500/20 cursor-not-allowed opacity-50'
                      }`}
                  >
